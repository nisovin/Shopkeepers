...
public final class NMSHandler implements NMSCallProvider {
	...
	public boolean areAttributesSimilar(ItemStack item1, ItemStack item2) {
		...
		net.minecraft.server.v1_8_R3.ItemStack nmsItem1 = CraftItemStack.asNMSCopy(item1);
		net.minecraft.server.v1_8_R3.ItemStack nmsItem2 = CraftItemStack.asNMSCopy(item2);
